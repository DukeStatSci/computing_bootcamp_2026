...
::: {.aside}
*Source*: [DCC Overview](https://oit-rc.pages.oit.duke.edu/rcsupportdocs/about/) and [DCC Architecture](https://oit-rc.pages.oit.duke.edu/rcsupportdocs/dcc/architecture/)
:::


# Acceptable Use<br/>& Data Security
...
* Duke's data protections do not follow your data - Restricted or Sensitive data can only go into a third party service if Duke has a data protection agreement (or similar contract) in place with that vendor.
...
| `/cwork/<netid>` | 830 TB | High speed volume, available to all users | None |
...
If this is of interest to you, I strongly recommend [RC training](https://oit-rc.pages.oit.duke.edu/rcsupportdocs/help/training/).
...
![](images/ondemand1.png){width="80%" fig-align=center}

![](images/ondemand2.png){width="85%" fig-align=center .fragment}

![](images/ondemand4.png){width="85%" fig-align=center .fragment}

![](images/ondemand5.png){width="85%" fig-align=center .fragment}
...
::: {.medium}
* **interactive** for short interactive sessions, resource limits are lower.
* **common** for jobs that will run on the DCC core nodes
...
* 10 CPUs, 64 GB memory, runtime <1 day
